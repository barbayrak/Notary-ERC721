...
const App = {
  ...
  tokenIdToStarInfo: async function(id) {
    ...
    if(starName.length > 0){
      App.setStatus("Contract name is :" + contractName + ".");
      App.setStatus("Contract symbol is : " + contractSymbol + ".");
      App.setStatus("Star name is :" + starName + ".");
    }else{
      App.setStatus("Star not found with id " + id);
    }
  }
